...
// student attendance
    ...
    Route::get('/admin/attendance/student', [AttendanceStudentController::class, 'AttendanceStudent']);   
    Route::post('/admin/attendance/student/save', [AttendanceStudentController::class, 'AttendanceStudentSubmit']);   
...
Route::group(['middleware' => 'teacher'], function (){
    ...
    Route::get('teacher/my_class_subject', [AssignClassTeacher::class, 'MyClassSubject']);
